export const personal = {
  ...
  bio: `My work focuses on ML infrastructure and systems for large-scale model training. I am currently a Software Engineer at <a href="https://about.meta.com/" target="_blank" rel="noopener noreferrer">Meta</a>, working on the Llama Research Platform team in GenAI infrastructure.`,
  bio2: `Previously, I interned at <a href="https://about.meta.com/" target="_blank" rel="noopener noreferrer">Meta</a> on YaRN positional encoding for context length extension, at <a href="https://www.alibabacloud.com/" target="_blank" rel="noopener noreferrer">Alibaba Cloud</a> on distributed computing, and conducted research on LLM agents at <a href="https://www.cmu.edu/" target="_blank" rel="noopener noreferrer">Carnegie Mellon University</a> and dialogue systems at <a href="https://www.columbia.edu/" target="_blank" rel="noopener noreferrer">Columbia University</a>. I'm driven by building reliable systems that make AI research practical at scale.`,
